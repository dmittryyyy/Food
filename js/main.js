...
//calculating
    ...
    function getStaticFormCalc(genderSelector, activeClass) {
    ...
    getStaticFormCalc('#gender', 'calculating__choose-item_active');
    getStaticFormCalc('.calculating__choose_big', 'calculating__choose-item_active');
