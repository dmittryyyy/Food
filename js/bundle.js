...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (calcForm);
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    function replaceNumSlider(total, current) {
        if (slides.length < 10) {
    ...
    replaceNumSlider(total, current);
    ...
    nextSlide.addEventListener('click', () => {
        ...
        dots.forEach(dot => dot.style.opacity = '.10');
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    const modalTimer = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimer), 40000);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-04-29');
});
